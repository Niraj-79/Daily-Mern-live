...
const MONGO_DB_URL = `mongodb+srv://${process.env.MONGO_DB_USERNAME}:${process.env.MONGO_DB_PASSWORD}@airbnb.xqq4y.mongodb.net/${process.env.MONGO_DB_DATABASE}`;
...
const logginStream = fs.createWriteStream(logginPath, { flags: "a" });
